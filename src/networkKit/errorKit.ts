...
const supportCodes: Array<ServiceError> = [
  ...
  },
  {
    ...
    url: '/platform/identity',
    message:
      "This endpoint expected a signed JWT (JSON Web Token) Bearer token for authorization but could not find it. Check your 'Authorization' header."
  },
  {
    code: 'JWTBearerNotFound', // trying string codes
    type: 'AUTHORIZATION',
  ...
  },
  {
    ...
    type: 'STREAMING',
    message:
      'For security reasons, access to this video streaming endpoint is currently limited to internal client IP addresses.',
    url: '/video'
  },
  {
    code: 1337,
    type: 'AUTHENTICATION',
    message:
      "The submitted token failed our automated verification checks. This error can happen when you're using an invalid token to request issuance of a Developer Token",
    url: '/identity/universal'
  },
  {
    code: 1030,
    ...
    message:
      'This domain no longer serves previous versions of the Cloud API. Please see the included article for more information.',

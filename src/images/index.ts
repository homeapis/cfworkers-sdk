...
/**
 * Signs an Image URL on _scontent.homeapis.com_
 * for the client to use for up to a week (defaults
 * to a day).
 */
const signImageViewUrlLite = async (image_id: string, account_uid_sha256: string, env: Env, time: number = 86400): Promise<String> => {
...
/**
 * New function to sign images on CDN (scontent.homeapis.com)
 * @param image
 * @param time
 * @param env
 * @returns
